...
function get_paging($write_pages, $cur_page, $total_page, $url, $add="")
{
    ...
    */
    $str .= '<a href="'.$url.($start_page-1).$add.'" class="pg_page pg_prev"></a>'.PHP_EOL;
    $str .= '<a href="'.$url.'1'.$add.'" class="pg_page">'.'1'.'<span class="sound_only">페이지</span></a>';
    if ($total_page > 2) {
    ...
    */
    $str .= '<a href="'.$url.($end_page+1).$add.'" class="pg_page pg_next"></a>'.PHP_EOL;
    /* 2015. 09. 04 수정 www
