...
?>
    ...
    <div class="box_main">
        ...
        <ul class="ul_company ul_company1 cf">
            <li><a class="on" href="<?php echo G5_URL;?>/company.php">Headquarter / Overseas Office</a></li>
            <!-- <li><a class="" href="<?php echo G5_URL;?>/ceo.php">CEO 인사말</a></li> -->
            <li><a class="" href="<?php echo G5_URL;?>/history.php">History</a></li>
        </ul>
        ...
        <div class="box_com1">
           ...
           <h3 class="tit_coms">Head Office</h3>
            <ul>
                <li>
                    <span class="tit_name">YHK Korea Co., Ltd</span> 
                    <!-- <span class="tit_des">YHK Korea Co., Ltd</span> -->
                </li>
                <li>
                    <span class="tit_name">Address:</span> 
                    <span class="tit_des">Room411, Kumho-town, 26 Gonwon-ro, Guro-gu, Seoul, 152-838, Korea</span>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <span class="tit_name">R&D and Business Partnership:</span> 
                    <span class="tit_des">info@yhkkorea.com</span>
                </li>
                <li>
                    <span class="tit_name">Sales and Marketing:</span> 
                    <span class="tit_des">sales@yhkkorea.com</span>
                </li>
                <li>
                    <span class="tit_name">Recruitment:</span> 
                    <span class="tit_des">hr@yhkkorea.com</span>
                </li>
                <li>
                    <span class="tit_name">General Inquiry:</span> 
                    <span class="tit_des">info@yhkkorea.com</span>
                </li>
        ...
        <span class="wdot mgbt20"></span>
        <h3 class="tit_coms">Overseas office</h3>
