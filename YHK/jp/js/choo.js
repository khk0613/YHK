$(function(){
    ...
    $('.box_submit .btn_submits').click(function(){
        if ( !$('.box_mail .box_check .checkbox').hasClass('checked') || $('#u_name').val().length == 0 || $('#u_company').val().length == 0 || $('#u_email').val().length == 0 || $('#u_phone').val().length == 0 || $('.box_mail input[type=text]').hasClass('alert') ) {
            ...
            location.href='http://www.yhkkorea.com';    
        }
    });    
    ...
    //     $('.wrap_head .wrap_drop .box_drop').css({'background-image':'url("../images/nav_bg2.png")'});
    // } else if ( link.match('siljuk') ) {
    //     $('.wrap_head .wrap_drop .box_drop').css({'background-image':'url("../images/nav_siljuk.png")'});
    // } else if ( link.match('gong') ) {
    //     $('.wrap_head .wrap_drop .box_drop').css({'background-image':'url("../images/nav_jepum.png")'});
    //  } 
