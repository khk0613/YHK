...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" class="frm_input" size="30" maxlength="50">
				<span style="color:#777;">※ http://www.youtube.com/embed/ 뒷부분</span>
			</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
				...
				<?php if($i==0) echo "<div style='color:#777;'>첨부파일1에는 동영상 썸네일 이미지를 넣어주세요.</div>"; ?>
			    <?php if($i==1) echo "<div style='color:#777;'>첨부파일2에는 mp4 동영상 파일을 넣어주세요.</div>"; ?>
