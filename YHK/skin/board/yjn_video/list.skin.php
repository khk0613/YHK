...
<div class="main_slider sub_slider">
    ...
    <div class="box_txt tech_bg">
        ...
        <span class="bt_title">동영상</span>
        <span class="bt_des">샤이니 와이퍼 테스트 , 실리콘 와이퍼 VS 고무와이퍼 비교 테스트</span>
    </div>
...
<div class="box_main box_board_basic cf">
    ...
    <?php 
        if( $bo_table == 'basic' || $bo_table == 'video' || $bo_table == 'pdf') {
            echo "
            <ul class='ul_company1 ul_company cf'>
        ...
        if ( $bo_table == 'basic' ) {
            ...
            echo "<p class='txt_board_head'>동영상</p>";
