...
<div class="main_slider sub_slider">
        <div class="box_txt tech_bg">
                ...
                <span class="bt_title">브로셔 다운로드</span>
    ...
    <?php 
        if( $bo_table == 'basic' || $bo_table == 'video' || $bo_table == 'pdf') {
            ...
            <ul class='ul_company cf'>
                ...
                <li><a class='' href='board.php?bo_table=video'>동영상</a></li>
                <li><a class='' href='board.php?bo_table=pdf'>브로셔</a></li>
            </ul>"
            ;
        }
        if ( $bo_table == 'basic' ) {
            ...
            echo "<p class='txt_board_head'>브로셔 다운로드</p>";
        }
    ?>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <thead>
        <tr >
            <th scope="col" style="height:50px; border-top:2px solid #333; font-size:14px; background:#f5f5f5; font-weight:bold; border-bottom:1px solid #333;">번호</th>
            <?php if ($is_checkbox) { ?>
            ...
            <?php } ?>
            <th scope="col"  style="height:50px; border-top:2px solid #333; font-size:14px; background:#f5f5f5; font-weight:bold; border-bottom:1px solid #333;">제목</th>
            <th scope="col" style="height:50px; border-top:2px solid #333; font-size:14px; background:#f5f5f5; font-weight:bold; border-bottom:1px solid #333;">다운로드</th>
            <!-- <th scope="col" style="background:white;">권한</th> -->
            <th scope="col" style="height:50px; border-top:2px solid #333; font-size:14px; background:#f5f5f5; font-weight:bold; border-bottom:1px solid #333;">작성자</th>
            <th scope="col" style="width:130px;height:50px; border-top:2px solid #333; font-size:14px; background:#f5f5f5; font-weight:bold; border-bottom:1px solid #333;"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>등록일</a></th>
