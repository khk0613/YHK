...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <ul class="bo_v_nb ul_page_gal">
        <li><a href="<?php echo $prev_href ?>" class="btn_b01 btn_b01_gal">이전글</a></li>
        <li><a href="<?php echo $next_href ?>" class="btn_b01 btn_b01_gal btn_b01_gal2">다음글</a></li>
    </ul>
    ...
    if ($view['link']) {
    ?>
    <div class="box_header_gal cf">
    <div class="box_gal_cover">
    ...
    <div class="box_inform">
        <table>
            <tbody>
                <tr>
                    <th>발주처</th>
                    <td><?php echo $view['baljuchu']; ?></td>
                </tr>
                <tr>
                    <th>위치</th>
                    <td><?php echo $view['witch']; ?></td>
                </tr>
                <tr>
                    <th>시공년도</th>
                    <td><?php echo $view['nyundo']; ?></td>
                </tr>
                <tr>
                    <th>시공영역</th>
                    <td><?php echo $view['yeongyeok']; ?></td>
                </tr>
                <tr>
                    <th>설명</th>
                    <td><?php echo $view['sulmyung']; ?></td>
                </tr>
            </tbody>
        </table>
        <li><a href="<?php echo $list_href ?>" class="btn_b01 btn_list btn_list2">목록보기</a></li>
    </div>
    </div>
     <!-- 관련링크 시작 { -->
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div class="box_contt box_contt_gal"><?php echo get_view_thumbnail($view['content']); ?></div>
